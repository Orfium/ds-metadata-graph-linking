...
def create_raw_graph_data_from_raw(sample_size, raw_data, raw_graph_data):
    factory.create_raw_graph_data_from_raw(sample_size=sample_size, raw_data=raw_data, raw_graph_data=raw_graph_data)
...
def split_hetero_dataset(processed_data, num_val, num_test, neg_sampling_ratio,
